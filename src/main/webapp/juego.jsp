...
<html>
    ...
    <body>
        <%
          ...
          int aidi=Integer.parseInt(sesione);
          JuegoVO juego=JuegoDAO.buscar_juego(aidi);
           ...
           // out.print("<img src='img/"+juego.getImg()+"'/>");
            ...
            out.print("<button>Adquirir Juego</button>");
            out.print("<p><a href='index.jsp'>Volver</a><p>");
